	...
	<div>
		...
		<label>
			...
			<select name="level" required>
				...
				<option value="0">kkthxbai - 0</option>
				<option value="1">neophyte - 1</option>
				<option value="2">fine - 2</option>
				<option value="3">bttr - 3</option>
				<option value="4">wat! - 4</option>
				<option value="5">teh hacker - 5</option>
			</select>
		</label>
